...
print("is mgr 1 an instance of Employee class: ",isinstance(mgr_1, oop_employee.Employee))
print("is mgr 1 an instance of Developer class: ",isinstance(mgr_1, oop_developer.Developer))
